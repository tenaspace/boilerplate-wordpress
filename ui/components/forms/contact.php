...
<form novalidate class="space-y-2" x-data="formContact($el)" data-action="<?php echo $action; ?>"
  data-nonce="<?php echo $nonce; ?>" @submit.prevent="onSubmit">
  <div>
    <input type="text" placeholder="<?php echo __('Full name', 'ts'); ?> *" class="w-full border px-5 py-2"
  ...
  <div>
    <input type="email" placeholder="<?php echo __('E-mail', 'ts'); ?> *" class="w-full border px-5 py-2"
  ...
  <div>
    <input type="tel" placeholder="<?php echo __('Phone number', 'ts'); ?> *" class="w-full border px-5 py-2"
  ...
  <div>
    <textarea placeholder="<?php echo __('Message', 'ts'); ?>" class="w-full border px-5 py-2 min-h-[120px]"
  ...
  <div>
    <button type="submit"
      ...
      :disabled="loading">
      <?php echo __('Submit', 'ts'); ?>
    </button>
  </div>
  <div x-show="loading" x-cloak>
    <?php echo __('Loading', 'ts') . '...'; ?>
  </div>
</form>