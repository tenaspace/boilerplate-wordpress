    ...
    <div class="<?php echo CLASSES['container']; ?>">
      <div class="flex flex-col items-center justify-center">
        ...
        <a href="<?php echo home_url(); ?>"
          class="<?php echo $tw->merge([CLASSES['typography']['small'], 'box-border inline-block rounded-lg border border-black bg-black px-6 py-2.5 text-center text-white']); ?>">Back
          to
          home page</a>
      </div>
    </div>
