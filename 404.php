  ...
  <div class="py-20">
    <div class="<?php echo CLASSES['container']; ?>">
      <div class="flex flex-col items-center justify-center">
        <div class="<?php echo $tw->merge([CLASSES['typography']['h1'], 'text-center text-8xl mb-4']); ?>">
          404</div>
        ...
        <a href="<?php echo home_url(); ?>"
          class="<?php echo $tw->merge([CLASSES['typography']['small'], 'box-border inline-block rounded-lg border border-ts-black bg-ts-black px-6 py-2.5 text-center text-white']); ?>">Back
          to
          home page</a>
      </div>
    </div>
