...
require_once (get_template_directory() . '/inc/ts-functions.php');
$theme = wp_get_theme('ts');
$ts = (object) [
	'version' => $theme['Version'],
	'main' => require_once (get_template_directory() . '/inc/ts.php'),
];
require_once (get_template_directory() . '/inc/ts-hooks.php');

$ts_functions = new Ts_Functions();

$ts_functions->require_all_files('/inc/classes');
...
if ($ts_functions->is_woocommerce_activated()) {
	require_once (get_template_directory() . '/inc/ts-woocommerce-functions.php');
	$ts->woocommerce = require_once (get_template_directory() . '/inc/ts-woocommerce.php');
